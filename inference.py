...
if __name__ == '__main__':
    ...
    gan = RL_Transformer_TrajGAN(latent_dim, keys, vocab_size, max_length, lat_centroid, lon_centroid, scale_factor)
    ...
    gan.generator.load_weights('/root/autodl-tmp/location-privacy-main/best_model/G_model_best.weights.h5') # params/G_model_2000.h5
